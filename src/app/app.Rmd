...
url <- "https://cloud-shiny.domino.tech:443/models/5bce2f134cedfd000727760e/latest/model"

last_modified <- file.info("data/processed/movies_with_overviews.pkl")$mtime 
```
